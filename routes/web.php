...
Route::group(['middleware' => ['not_installed']], function () {
    ...
    // Also allow GET logout for compatibility with older links (Auth::routes() already registers POST logout named 'logout')
    Route::get('logout', 'Auth\LoginController@logout');  // no ->name() — avoids duplicate name conflict
