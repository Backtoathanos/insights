const id = "en/example-1/index.mdx";
						const collection = "blog";
						const slug = "en/example-1";
						...
						const data = {title:"Make Awesome Blog Posts People Will Love",description:"Make your blog posts stand out with these simple tips",authors:[{slug:"web-reaper",collection:"authors"}],pubDate:new Date(1691366400000),heroImage:
						new Proxy({"src":"/_astro/heroImage.DYd-Iujd.jpg","width":1920,"height":1280,"format":"jpg","fsPath":"/home/blackridgeorg/public_html/src/content/blog/en/example-1/heroImage.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/blackridgeorg/public_html/src/content/blog/en/example-1/heroImage.jpg";
							}
					...
					,categories:["blogging"],draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/blackridgeorg/public_html/src/content/blog/en/example-1/index.mdx",
							rawData: undefined,
						};
