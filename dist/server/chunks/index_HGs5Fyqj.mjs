const id = "en/example-2/index.mdx";
						const collection = "blog";
						const slug = "en/example-2";
						...
						const data = {title:"How to Write SEO Friendly Blog Posts",description:"Help your website show up on Google searches by following some of our SEO tips",authors:[{slug:"web-reaper",collection:"authors"}],pubDate:new Date(1687305600000),heroImage:
						new Proxy({"src":"/_astro/heroImage.D9ECHclc.jpg","width":1920,"height":1284,"format":"jpg","fsPath":"/home/blackridgeorg/public_html/src/content/blog/en/example-2/heroImage.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/blackridgeorg/public_html/src/content/blog/en/example-2/heroImage.jpg";
							}
							
							return target[name];
						}
					})
					,categories:["blogging"],draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/blackridgeorg/public_html/src/content/blog/en/example-2/index.mdx",
							rawData: undefined,
						};
