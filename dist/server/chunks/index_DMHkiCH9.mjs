const id = "en/tailwind-gradient-underline/index.mdx";
						const collection = "blog";
						const slug = "en/tailwind-gradient-underline";
						...
						new Proxy({"src":"/_astro/heroImage.CO-5U07u.jpg","width":1920,"height":1152,"format":"jpg","fsPath":"/home/blackridgeorg/public_html/src/content/blog/en/tailwind-gradient-underline/heroImage.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/blackridgeorg/public_html/src/content/blog/en/tailwind-gradient-underline/heroImage.jpg";
							}
					...
					,categories:["cool code"],draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/blackridgeorg/public_html/src/content/blog/en/tailwind-gradient-underline/index.mdx",
							rawData: undefined,
						};
