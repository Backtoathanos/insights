const id = "fr/example-3/index.mdx";
						const collection = "blog";
						const slug = "fr/example-3";
						...
						const data = {title:"Tips for Freelance Website Development",description:"Understand some basics and ideas of freelance website development",authors:[{slug:"web-reaper",collection:"authors"}],pubDate:new Date(1685923200000),heroImage:
						new Proxy({"src":"/_astro/heroImage.DxwTuXkv.jpg","width":1920,"height":1280,"format":"jpg","fsPath":"/home/blackridgeorg/public_html/src/content/blog/fr/example-3/heroImage.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/blackridgeorg/public_html/src/content/blog/fr/example-3/heroImage.jpg";
							}
					...
					,categories:["blogging"],draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/blackridgeorg/public_html/src/content/blog/fr/example-3/index.mdx",
							rawData: undefined,
						};
