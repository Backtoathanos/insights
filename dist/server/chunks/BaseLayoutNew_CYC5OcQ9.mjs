...
const $$BaseLayoutHead = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$BaseLayoutHead;
  const {
    type = "general",
    title,
    description,
...
<\/script>`, "<!-- no fallback as I saw issues with firefox fallback -->", ""])), preconnect === true && renderTemplate`<link rel="preconnect" href="https://sendspark.com">`, addAttribute(Astro2.generator, "content"), renderComponent($$result, "Seo", $$Seo, { "type": type, "title": title, "description": description, "image": image, "authors": authors, "postFrontmatter": postFrontmatter, "noindex": noindex }), siteSettings.useViewTransitions);
}, "/home/blackridgeorg/public_html/src/layouts/BaseLayoutHead.astro", void 0);

const $$Astro = createAstro("https://www.blackridgeresearch.com");
const $$BaseLayoutNew = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$BaseLayoutNew;
  const {
    type = "general",
    title,
    description,
