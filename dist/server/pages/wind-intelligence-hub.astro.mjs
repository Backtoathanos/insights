...
const $$WindIntelligenceHub = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$WindIntelligenceHub;
  const currLocale = getLocaleFromUrl(Astro2.url);
  getTranslatedData("teamData", currLocale);
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Wind Intelligence Hub | Blackridge Research & Consulting", "description": "All about our super awesome small business team!" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section id="" class="mt-10 bg-primary-600"> <div class="grid grid-cols-2 gap-4 sm:grid-cols-1 lg:grid-cols-2"> <div class="ml-24 mt-24 text-white"> <h1 class="h2 font-semibold text-white">Wind Intelligence Hub</h1> <p>A Global Wind Intelligence Service</p> </div> <div class="text-center"> <div class="flex justify-center p-3"> <div class=""> ${renderComponent($$result2, "Image", $$Image, { "src": agreement, "alt": "background", "loading": "lazy", "width": 1170, "densities": [1, 1.5, 2], "class": "h-80 w-auto p-2", "aria-hidden": "true" })} </div> </div> </div> </div> </section> <div class="col-sm-12 mt-10 text-center"> <a href="/contact-us" class="mr-10 bg-black p-2 text-white dark:bg-white dark:text-black">See it in Action <i class="fas fa-long-arrow-alt-right"></i></a> </div>  <div class="mb-2 mt-5 bg-gray-300 p-4 text-xl font-semibold dark:text-black"> <h3 class="ml-10">Who Needs This Service?</h3> </div> <section class="site-container mx-auto mt-3 py-3"> <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2"> <div class="p-4"> <h4 class="font-semibold">Types of Companies:</h4> <ul class="list-inside list-disc"> <li>Wind Turbine Manufacturers</li> <li>Raw Material and Component Suppliers</li> <li>EPC/Developers</li> <li>Power Plant Owners/Utilities</li> <li>Operation &amp; Maintenance (O&amp;M) Companies</li> <li>Logistics and Warehousing</li> <li>Others</li> </ul> </div> <div class="p-3"> <div class="space-y-2"> <h4 class="font-semibold">Types of Roles</h4> <ul class="list-inside list-disc"> <li>Business Development Teams</li> <li>Processor Management</li> <li>Project Managers</li> <li>Marketing Teams</li> <li>Strategy, Competitor Intelligence Teams</li> <li>Product Managers among others</li> </ul> </div> </div> </div> </section> <div class="mb-2 mt-5 bg-green-700 p-4 text-xl font-semibold dark:text-black"> <h3 class="ml-10">What’s Included</h3> </div> <section class="site-container mx-auto mt-3 py-3"> <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2"> <div class="space-y-4"> <div> <h4 class="font-semibold">Wind Power Installation Database</h4> <p>
Covers installation data for more than 100 countries from 1990. This tool helps in
						visualizing installation data with live dashboards and reports.
</p> </div> <div> <h4 class="font-semibold">Wind Turbine OEMs Market Share (Historical &amp; Forecast)</h4> <p>
Covers both historical and forecasted market share of top 10 players in the PV module
						manufacturing sector.
</p> </div> <div> <h4 class="font-semibold">Wind Power Plant Projects Tracker</h4> <p>
Over 25,000+ projects across the world above 1 MW capacity. More than 20 parameters for
...
Covers company profiles of key players in the Wind power ecosystem. List of relevant
						products and services, latest financial data for public companies, key competitor
						information, recent developments, M&amp;A activity, are some of the details provided for
						all the companies profiled. SWOT analysis will be provided on request.
...
}, "/home/blackridgeorg/public_html/src/pages/wind-intelligence-hub.astro", void 0);

const $$file = "/home/blackridgeorg/public_html/src/pages/wind-intelligence-hub.astro";
const $$url = "/wind-intelligence-hub";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
	__proto__: null,
	default: $$WindIntelligenceHub,
	file: $$file,
	url: $$url
