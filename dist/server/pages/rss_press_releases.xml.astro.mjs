...
const apiUrl = "https://adminapi.blackridgeresearch.com/blog/live/pressrelease?page=1&limit=1000000";
...
async function GET(context) {
  return rss({
    ...
    customData: `<atom:link href="${context.site}rss_press_releases.xml" rel="self" type="application/rss+xml" />`,
    // items (each post)
    items: posts.posts.map((post) => ({
      title: post.title,
      link: getRelativeLocaleUrl(rssLocale, `/press-releases/${post.page_title}/`),
